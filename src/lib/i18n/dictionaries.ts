...
const en = {
  ...
  shop: {
    ...
    sortRarityAsc: "Rarity: Common to Rare",
    sortRarityDesc: "Rarity: Rare to Common",
  ...
  binder: {
    title: "My Binder",
    subtitle: "Track the cards you actually own — separate from your wishlist.",
    back: "Back to Account",
    backToBinders: "My Binders",
    statsBinders: "Binders",
    statsCardsTracked: "Cards Tracked",
    statsUniqueListings: "Unique Listings",
    statsEstimatedValue: "Estimated Value",
    newBinder: "New Binder",
    newBinderPlaceholder: "e.g. Chaos Rising",
    emptyBinders: "Create your first binder above to start tracking your collection.",
    delete: "Delete",
    deleteConfirm: 'Delete "{name}"? This removes all {count} card(s) tracked in it.',
    listing: "listing",
    listingPlural: "listings",
    card: "card",
    cardPlural: "cards",
    emptyItems: "No cards in this binder yet — search for one above to add it.",
    addCard: "Add a card",
    ...
    estimatedValueEach: "Estimated value: {price} each (based on your fixed price table)",
    save: "Save",
    remove: "Remove",
    errorLimit: "You can have up to {max} binders.",
    errorDuplicate: "You already have a binder with that name.",
    errorFailed: "Couldn't create that binder — try again.",
  },
  faq: {
...
const nl: Dictionary = {
  ...
  shop: {
    ...
    sortRarityAsc: "Zeldzaamheid: gewoon naar zeldzaam",
    sortRarityDesc: "Zeldzaamheid: zeldzaam naar gewoon",
  ...
  binder: {
    title: "Mijn Binder",
    subtitle: "Houd bij welke kaarten je echt bezit — los van je verlanglijst.",
    back: "Terug naar Account",
    backToBinders: "Mijn binders",
    statsBinders: "Binders",
    statsCardsTracked: "Getelde kaarten",
    statsUniqueListings: "Unieke items",
    statsEstimatedValue: "Geschatte waarde",
    newBinder: "Nieuwe binder",
    newBinderPlaceholder: "bijv. Chaos Rising",
    emptyBinders: "Maak hierboven je eerste binder aan om je verzameling bij te houden.",
    delete: "Verwijderen",
    deleteConfirm: '"{name}" verwijderen? Dit verwijdert alle {count} kaart(en) hierin.',
    listing: "item",
    listingPlural: "items",
    card: "kaart",
    cardPlural: "kaarten",
    emptyItems: "Nog geen kaarten in deze binder — zoek er hierboven een op om toe te voegen.",
    addCard: "Kaart toevoegen",
    searchPlaceholder: "Zoek kaarten...",
    variant: "Variant",
    condition: "Conditie",
    quantity: "Aantal",
    addToBinder: "Toevoegen aan binder",
    estimatedValueEach: "Geschatte waarde: {price} per stuk (op basis van je vaste prijslijst)",
    save: "Opslaan",
    remove: "Verwijderen",
    errorLimit: "Je kunt maximaal {max} binders hebben.",
    errorDuplicate: "Je hebt al een binder met die naam.",
    errorFailed: "Kon deze binder niet aanmaken — probeer het opnieuw.",
  },
  faq: {
